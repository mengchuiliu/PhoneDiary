...
public class SpringIndicator extends FrameLayout {
    ...
    public void setViewPager(final ViewPager viewPager, final WaterWave btn_wel, final SpringIndicator
            springIndicator) {
        this.viewPager = viewPager;
        this.btn_wel = btn_wel;
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                if (position < tabs.size() - 1) {
                    ...
                    if (positionOffset < radiusOffsetHead) {
                        ...
                        springView.getHeadPoint().setRadius(((positionOffset - radiusOffsetHead) / (1 -
                                radiusOffsetHead) * radiusOffset + radiusMin));
                    }
                    float radiusOffsetFoot = 0.5f;
                    if (positionOffset < radiusOffsetFoot) {
                        springView.getFootPoint().setRadius((1 - positionOffset / radiusOffsetFoot) * radiusOffset +
                                radiusMin);
                    } else {
